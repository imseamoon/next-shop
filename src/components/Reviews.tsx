...
return <div className={cn("animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shaeow-xl shadow-slate-900/5", className)} {...props} style={{animationDelay}}>
<Phone imgSrc={imgSrc} />
</div>
}
...
const Reviews = () => {
  return (
    <MaxWidthWrapper className='relative max-w-5xl'>
        <Image src="/what-people-are-buying.png" alt="what people are buying" height={1000} width={1000} aria-hidden="true" className='w-auto h-24 absolute select-none hidden xl:block -left-32 top-1/3' />
        <ReviewGrid />
    </MaxWidthWrapper>
  )
}
